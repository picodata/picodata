...
## Generate a diagram in Bottlecaps

1. Open [https://www.bottlecaps.de/rr/ui](https://www.bottlecaps.de/rr/ui).
...
4. Paste grammar into Bottlecaps on the `Edit` tab.
...
1. Add a `viewBox` attribute to the `<svg>` tag using the document size.
