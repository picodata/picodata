...
DEAD_LIST = [
    ...
    "crates/picodata-plugin/README.md",
    "uv.lock",
    "crates/sql-executor/src/backend/sql/ir/tests/",
    "crates/sql-executor/src/executor/tests/",
    "crates/sql-frontend/src/frontend/sql/ir/tests/",
    "crates/sql-planner/doc/",
    "crates/sql-planner/tests/",
    "tarantool-sys/.clusterfuzzlite/Dockerfile",
    "tarantool-sys/.github/",
    "tarantool-sys/.gitlab/merge_request_templates/",
    "tarantool-sys/changelogs/",
    "tarantool-sys/CONTRIBUTING.md",
    "tarantool-sys/doc/",
    "tarantool-sys/docker/Dockerfile.ci",
    "tarantool-sys/docker/Dockerfile.release",
    ...
    "tarantool-sys/third_party/nghttp2/doc/_exts/rubydomain/rubydomain.py",
    "tarantool-sys/third_party/nghttp2/doc/bash_completion/make_bash_completion.py",
    "tarantool-sys/third_party/nghttp2/doc/mkapiref.py",
    "tarantool-sys/third_party/nghttp2/docker/Dockerfile",
    "tarantool-sys/third_party/nghttp2/Dockerfile.android",
    "tarantool-sys/third_party/nghttp2/integration-tests/alt-server.crt",
    "tarantool-sys/third_party/nghttp2/integration-tests/alt-server.key",
    "tarantool-sys/third_party/nghttp2/integration-tests/nghttpx_http1_test.go",
    "tarantool-sys/third_party/nghttp2/integration-tests/nghttpx_http2_test.go",
    "tarantool-sys/third_party/nghttp2/integration-tests/nghttpx_http3_test.go",
    "tarantool-sys/third_party/nghttp2/integration-tests/server.crt",
    "tarantool-sys/third_party/nghttp2/integration-tests/server.key",
    "tarantool-sys/third_party/nghttp2/integration-tests/server_tester.go",
    "tarantool-sys/third_party/nghttp2/tests/end_to_end.py",
    ...
    "tarantool-sys/third_party/zstd/contrib/docker/Dockerfile",
    ...
    "tarantool/docker/picodata.Dockerfile",
    "tarantool/docker/vanilla.Dockerfile",
    "tarantool/examples/",
    "tarantool/README.md",
    "tarantool/tests/",
    ...
    "test/manual/",
    "test/pgproto/",
    "test/plugins/plug_wrong_version/",
    "test/plugins/plug_26_1/",
    "test/sqlite_tests_converter.py",
    "test/ssl_certs/",
    "tools/build_rolling_binaries.py",
    "tools/check_rust.sh",
    "tools/check_tnt.sh",
    "tools/clone.sh",
    "tools/coverage.py",
    "tools/install_rolling_binaries.py",
    "tools/plan-drawer/",
    "tools/sanitizer.py",
    "vshard/.github/",
    "vshard/changelogs/",
    ...
    "webui/dev/webui_mock_large_cluster/test_webui_requirements.txt",
]
