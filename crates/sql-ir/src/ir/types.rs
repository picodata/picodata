...
impl From<UnrestrictedType> for TypeSystemType {
    fn from(value: UnrestrictedType) -> Self {
        match value {
            UnrestrictedType::Integer => TypeSystemType::Integer,
            UnrestrictedType::Decimal => TypeSystemType::Numeric,
            UnrestrictedType::Double => TypeSystemType::Double,
            UnrestrictedType::String => TypeSystemType::Text,
            UnrestrictedType::Boolean => TypeSystemType::Boolean,
            UnrestrictedType::Datetime => TypeSystemType::Datetime,
            UnrestrictedType::Any => TypeSystemType::Any,
            UnrestrictedType::Uuid => TypeSystemType::Uuid,
            UnrestrictedType::Array(n) => TypeSystemType::Array(n.into()),
            UnrestrictedType::Map => TypeSystemType::Map,
        }
    }
}

impl From<TypeSystemType> for DerivedType {
    fn from(value: TypeSystemType) -> Self {
        match value {
            TypeSystemType::Integer => DerivedType::new(UnrestrictedType::Integer),
            TypeSystemType::Double => DerivedType::new(UnrestrictedType::Double),
            TypeSystemType::Numeric => DerivedType::new(UnrestrictedType::Decimal),
            TypeSystemType::Text => DerivedType::new(UnrestrictedType::String),
            TypeSystemType::Boolean => DerivedType::new(UnrestrictedType::Boolean),
            TypeSystemType::Datetime => DerivedType::new(UnrestrictedType::Datetime),
            TypeSystemType::Uuid => DerivedType::new(UnrestrictedType::Uuid),
            TypeSystemType::Array(n) => DerivedType::new(UnrestrictedType::Array(n.into())),
            TypeSystemType::Map => DerivedType::new(UnrestrictedType::Map),
            TypeSystemType::Any => DerivedType::new(UnrestrictedType::Any),
        }
    }
}
