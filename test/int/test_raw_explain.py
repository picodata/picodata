...
def test_raw_explain(cluster: Cluster):
    ...
    assert data == [
        ...
        "",
        "2. Query (ROUTER):",
        'SELECT "COL_0" as "id", "COL_1" as "name", "COL_2" as "product_units" FROM ( SELECT "COL_0", "COL_1", "COL_2" FROM "TMP_3521300013320375007_0136" ) ORDER BY 1 LIMIT 1',
        "+----------+-------+------+---------------------------------------------------------+",
        "| selectid | order | from | detail                                                  |",
        "+===================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_3521300013320375007_0136 (~1048576 rows) |",
        "|----------+-------+------+---------------------------------------------------------|",
    ...
    assert data == [
        ...
        "",
        "2. Query (ROUTER):",
        'SELECT "id", "name", "product_units" FROM ( SELECT "COL_0" as "id", "COL_1" as "name", "COL_2" as "product_units" FROM ( SELECT "COL_0", "COL_1", "COL_2" FROM "TMP_3482083385347377238_0136" ) GROUP BY "COL_0", "COL_1", "COL_2" ) ORDER BY 1 LIMIT 1',
        "+----------+-------+------+---------------------------------------------------------+",
        "| selectid | order | from | detail                                                  |",
        "+===================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_3482083385347377238_0136 (~1048576 rows) |",
        "|----------+-------+------+---------------------------------------------------------|",
    ...
    assert data == [
        ...
        "| 0        | 0     | 0    | SCAN TABLE testing_space (~1048576 rows)                 |",
        "|----------+-------+------+----------------------------------------------------------|",
        "| 0        | 1     | 1    | SCAN TABLE TMP_10649492124332855473_0136 (~1048576 rows) |",
        "|----------+-------+------+----------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR GROUP BY                             |",
        "+----------+-------+------+----------------------------------------------------------+",
        "",
        ...
        "| selectid | order | from | detail                                                  |",
        "+===================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_4920394822022308715_0136 (~1048576 rows) |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR GROUP BY                            |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR ORDER BY                            |",
