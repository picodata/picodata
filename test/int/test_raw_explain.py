...
def test_raw_explain(cluster: Cluster):
    ...
    assert data == [
        ...
        "",
        "2. Query (ROUTER):",
        'SELECT "COL_0" as id, "COL_1" as name, "COL_2" as product_units FROM ( SELECT "COL_0", "COL_1", "COL_2" FROM "TMP_13220659973689095005_0136" ) ORDER BY 1 LIMIT 1',
        "+----------+-------+------+----------------------------------------------------------+",
        "| selectid | order | from | detail                                                   |",
        "+====================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_13220659973689095005_0136 (~1048576 rows) |",
        "|----------+-------+------+----------------------------------------------------------|",
    ...
    assert data == [
        ...
        "",
        "2. Query (ROUTER):",
        'SELECT id, name, product_units FROM ( SELECT "COL_0" as id, "COL_1" as name, "COL_2" as product_units FROM ( SELECT "COL_0", "COL_1", "COL_2" FROM "TMP_11019145509151764786_0136" ) GROUP BY "COL_0", "COL_1", "COL_2" ) ORDER BY 1 LIMIT 1',
        "+----------+-------+------+----------------------------------------------------------+",
        "| selectid | order | from | detail                                                   |",
        "+====================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_11019145509151764786_0136 (~1048576 rows) |",
        "|----------+-------+------+----------------------------------------------------------|",
    ...
    assert data == [
        ...
        "| 0        | 0     | 0    | SCAN TABLE testing_space (~1048576 rows)                |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 1     | 1    | SCAN TABLE TMP_2376632894843436093_0136 (~1048576 rows) |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR GROUP BY                            |",
        "+----------+-------+------+---------------------------------------------------------+",
        "",
        ...
        "| selectid | order | from | detail                                                  |",
        "+===================================================================================+",
        "| 0        | 0     | 0    | SCAN TABLE TMP_9969612932592719861_0136 (~1048576 rows) |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR GROUP BY                            |",
        "|----------+-------+------+---------------------------------------------------------|",
        "| 0        | 0     | 0    | USE TEMP B-TREE FOR ORDER BY                            |",
