...
╰─────────────────────────────────╯
''
SELECT "e"."a" as "gr_expr_1", "t2"."COL_2" as "gr_expr_2" FROM "t" as "e" INNER JOIN ( SELECT "COL_0", "COL_1", "COL_2", "COL_3" FROM "_tmp_15026114344058690898_0136" ) as "t" ON "e"."a" = "t"."COL_2" INNER JOIN ( SELECT "COL_0", "COL_1", "COL_2", "COL_3" FROM "_tmp_15026114344058690898_1136" ) as "t2" ON CAST(true AS bool) GROUP BY "e"."a", "t2"."COL_2"
''
plan:
    [0] SCAN TABLE _tmp_15026114344058690898_0136 (~1048576 rows)
        [0] SCAN TABLE _tmp_15026114344058690898_1136 (~1048576 rows)
...
╰───────────────────╯
''
SELECT CAST(4 AS int) as "col_1" FROM ( SELECT "COL_1" as "b", "COL_0" as "a" FROM ( SELECT "COL_0", "COL_1" FROM "_tmp_12639920369207631279_2136" ) GROUP BY "COL_0", "COL_1" ) as "f"
''
plan:
    [0] SCAN TABLE _tmp_12639920369207631279_2136 (~1048576 rows)
    [0] USE TEMP B-TREE FOR GROUP BY
''
╭────────────────────────────────────────╮
...
╰────────────────────────────────────────╯
''
SELECT ( SELECT "COL_0" FROM "_tmp_16211560185462215110_3136" ) as "col_1" UNION SELECT "t2"."b" FROM "t2"
''
plan:
    [1] EXECUTE SCALAR SUBQUERY 2
    [2] SCAN TABLE _tmp_16211560185462215110_3136 (~1048576 rows)
...
╰───────────────────╯
''
SELECT ( SELECT "COL_0" FROM "_tmp_7688618212111086671_5136" EXCEPT SELECT "COL_0" FROM "_tmp_7688618212111086671_12136" ) as "col_1"
''
plan:
    [0] EXECUTE SCALAR SUBQUERY 1
    [2] SCAN TABLE _tmp_7688618212111086671_5136 (~1048576 rows)
    [3] SCAN TABLE _tmp_7688618212111086671_12136 (~1048576 rows)
