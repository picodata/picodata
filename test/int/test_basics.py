...
Insert({_pico_index}, [{_pico_peer_address},0,"raft_id","tree",[{{"unique":true}}],[["raft_id",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_instance},0,"instance_id","tree",[{{"unique":true}}],[["instance_id",null,null,null,null]],true,0,1]),
Insert({_pico_index}, [{_pico_instance},1,"raft_id","tree",[{{"unique":true}}],[["raft_id",null,null,null,null]],true,0,1]),
Insert({_pico_index}, [{_pico_instance},2,"replicaset_id","tree",[{{"unique":false}}],[["replicaset_id",null,null,null,null]],true,0,1]),
Insert({_pico_table}, [{_pico_property},"_pico_property",["global"],[["key","string",false],["value","any",false]],0,true,"memtx",1]),
Insert({_pico_index}, [{_pico_property},0,"key","tree",[{{"unique":true}}],[["key",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_replicaset},0,"replicaset_id","tree",[{{"unique":true}}],[["replicaset_id",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_user},0,"id","tree",[{{"unique":true}}],[["id",null,null,null,null]],true,0,1]),
Insert({_pico_index}, [{_pico_user},1,"name","tree",[{{"unique":true}}],[["name",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_privilege},0,"primary","tree",[{{"unique":true}}],[["grantee_id",null,null,null,null],["object_type",null,null,null,null],["object_id",null,null,null,null],["privilege",null,null,null,null]],true,0,1]),
Insert({_pico_index}, [{_pico_privilege},1,"object","tree",[{{"unique":false}}],[["object_type",null,null,null,null],["object_id",null,null,null,null]],true,0,1]),
Insert({_pico_table}, [{_pico_tier},"_pico_tier",["global"],[["name","string",false],["replication_factor","unsigned",false]],0,true,"memtx",1]),
Insert({_pico_index}, [{_pico_tier},0,"name","tree",[{{"unique":true}}],[["name",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_routine},0,"id","tree",[{{"unique":true}}],[["id",null,null,null,null]],true,0,1]),
Insert({_pico_index}, [{_pico_routine},1,"name","tree",[{{"unique":true}}],[["name",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_plugin},0,"name","tree",[{{"unique":true}}],[["name",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_service},0,"name","tree",[{{"unique":true}}],[["plugin_name",null,null,null,null],["name",null,null,null,null],["version",null,null,null,null]],true,0,1]),
...
Insert({_pico_index}, [{_pico_service_route},0,"routing_key","tree",[{{"unique":true}}],[["instance_id",null,null,null,null],["plugin_name",null,null,null,null],["service_name",null,null,null,null]],true,0,1])
)|
|  0  | 1  |AddNode(1)|
|  0  | 2  |-|
