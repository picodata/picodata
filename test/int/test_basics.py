...
+-----+----+-----+--------+
|  1  | 1  |1.0.1|Insert(pico_peer_addresses, [1,"127.0.0.1:{p}"])|
|  2  | 1  |1.0.2|PersistPeer(i1, 1, r1, Offline(0), 1, {b})|
|  3  | 1  |1.0.3|Insert(cluster_state, ["replication_factor",1])|
|  4  | 1  |1.0.4|Insert(cluster_state, ["desired_schema_version",0])|
|  5  | 1  |     |AddNode(1)|
|  6  | 2  |     |-|
|  7  | 2  |1.1.1|PersistPeer(i1, 1, r1, Offline(0) -> Online(1), 7, {b})|
|  8  | 2  |1.1.2|PersistPeer(i1, 1, r1, RaftSynced(1) -> Online(1), 8, {b})|
|  9  | 2  |1.1.3|PersistPeer(i1, 1, r1, Replicated(1) -> Online(1), 9, {b})|
| 10  | 2  |1.1.4|Insert(replicasets, ["r1","e0df68c5-e7f9-395f-86b3-30ad9e1b7b07","i1",1.0,0])|
| 11  | 2  |1.1.5|PersistPeer(i1, 1, r1, ShardingInitialized(1) -> Online(1), 11, {b})|
| 12  | 2  |1.1.6|Replace(cluster_state, ["vshard_bootstrapped",true])|
| 13  | 2  |1.1.7|PersistPeer(i1, 1, r1, Online(1), 13, {b})|
+-----+----+-----+--------+
""".format(  # noqa: E501
        p=instance.port, b="{}"
    )
