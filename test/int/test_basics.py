...
Insert(_pico_table, [{_pico_bucket},"_pico_bucket",{{"Global":null}},[{{"field_type":"string","is_nullable":false,"name":"tier_name"}},{{"field_type":"unsigned","is_nullable":false,"name":"bucket_id_start"}},{{"field_type":"unsigned","is_nullable":false,"name":"bucket_id_end"}},{{"field_type":"string","is_nullable":false,"name":"state"}},{{"field_type":"string","is_nullable":false,"name":"current_replicaset_name"}},{{"field_type":"string","is_nullable":true,"name":"target_replicaset_name"}}],0,true,"memtx",1,""]),
