...
|  9  | 2  |1.1.3|Insert(_picodata_replicaset, ["r1","e0df68c5-e7f9-395f-86b3-30ad9e1b7b07","i1",[0.0,"Auto","Initial"],0])|
| 10  | 2  |1.1.4|PersistInstance(i1, 1, r1, Replicated(1) -> Online(1), {b})|
| 11  | 2  |1.1.5|Update(_picodata_replicaset, ["r1"], [["=","weight[1]",1.0], ["=","weight[3]","UpToDate"]])|
| 12  | 2  |1.1.6|PersistInstance(i1, 1, r1, ShardingInitialized(1) -> Online(1), {b})|
| 13  | 2  |1.1.7|Replace(_picodata_property, ["vshard_bootstrapped",true])|
| 14  | 2  |1.1.8|PersistInstance(i1, 1, r1, Online(1), {b})|
+-----+----+-----+--------+
""".format(  # noqa: E501
        p=instance.port, b="{}"
    )
