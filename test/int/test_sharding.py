...
def test_rebalancing_tier_has_bucket_id_in_pk(cluster: Cluster, engine: str):
    i1 = cluster.add_instance(replicaset_name="r1")
    cluster.wait_until_instance_has_this_many_active_buckets(i1, 3000)
    ...
    assert res[0][5] == [[0, "unsigned", None, False, None], [1, "integer", None, False, None]]
