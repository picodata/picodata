...
mod tests {
    ...
    fn test_bool_folding12() {
        let query = r#"SELECT * from t WHERE true = true = true = (a = b)"#;
    ...
    fn test_bool_folding13() {
        let query = r#"SELECT * from t WHERE (a = b) = true = true = true"#;
    ...
    fn test_bool_folding14() {
        let query = r#"SELECT * from t WHERE true AND a = b"#;
    ...
    fn test_bool_folding15() {
        let query = r#"SELECT * from t WHERE false AND a = b"#;
    ...
    fn test_bool_folding16() {
        let query = r#"SELECT * from t WHERE true OR a = b"#;
    ...
    fn test_bool_folding17() {
        let query = r#"SELECT * from t WHERE false OR a = b"#;
    ...
    fn test_bool_folding18() {
        let query = r#"SELECT * from hash_testing WHERE product_units = true"#;
    ...
    fn test_bool_folding19() {
        let query = r#"SELECT * from t WHERE (a = b) <> false"#;
    ...
    fn test_bool_folding20() {
        let query = r#"SELECT * from t WHERE false <> (a = b)"#;
    ...
    fn test_bool_folding21() {
        ...
        let query = r#"SELECT * from t WHERE true OR a IN (SELECT a FROM t)"#;
    ...
    fn test_bool_folding23() {
        ...
        let query = r#"SELECT * FROM t JOIN t AS t2 ON true OR t.a IN (SELECT a FROM t)"#;
    ...
    fn test_bool_folding24() {
        ...
        let query = r#"SELECT * FROM t JOIN t AS t2
    ...
    fn test_bool_folding25() {
        let query = r#"select * from (values(1)) where
