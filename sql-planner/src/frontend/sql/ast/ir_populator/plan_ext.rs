...
impl Plan {
    ...
    pub(in crate::frontend::sql) fn add_replaced_subquery<M: Metadata>(
        &mut self,
        sq_id: NodeId,
    ...
    pub(in crate::frontend::sql) fn fix_subquery_rows<M: Metadata>(
        &mut self,
        worker: &mut ExpressionWalker<M>,
        rel_id: NodeId,
    ) -> Result<(), SbroadError> {
...
impl Plan {
    pub(in crate::frontend::sql) fn replace_group_by_ordinals_with_references(
        &mut self,
    ) -> Result<(), SbroadError> {
...
impl Plan {
    ...
    pub(in crate::frontend::sql) fn set_types_in_parameter_nodes(
        &mut self,
        params: &[DerivedType],
    ) -> Result<(), SbroadError> {
