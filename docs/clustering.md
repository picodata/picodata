...
Например, при корректном запланированном выводе инстанса из строя
...
на других — это может стать причиной потери кворума в кластере. Ниже
данная ситуация рассмотрена подробнее.
...
работающих кластерных функциях SQL см. в разделе [Возможности
кластерного SQL](../sql_support).
