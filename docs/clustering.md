...
- `box.cfg.replication` — список веб-адресов (URLs) для репликации.
...
работающих кластерных функциях SQL см. в разделе [Работа с SQL в Picodata](../sbroad/sql_index).
