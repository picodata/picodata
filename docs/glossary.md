# Глоссарий
## Общие сведения
Данный содержит описание основных терминов, используемых в Picodata.
...
**Группа инстансов** является более крупным образованием, чем репликасет. См пояснительную [картинку](glossary.md#groups).
