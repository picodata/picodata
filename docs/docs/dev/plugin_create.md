...
использовать Picodata в роли кеширующей БД, хранящей данные о погоде. Мы
...
мы будем кешировать и сохранять в базе данных и, если к нам придет еще
...
значения таймаутов. Мы пока не хотим настраивать кеширование,
...
Вернемся к задаче кеширования (наша цель — сохранять результаты запросов
...
Аналогично напишем запрос на вставку в кеш после получения данных:
