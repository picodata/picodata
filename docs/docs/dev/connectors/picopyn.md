...
- асинхронный API, основанный на [asyncpg]
    - маршрутизация запросов с учётом распределения данных по шардам (см. ограничения и подробности в [документации](https://picopyn.readthedocs.io/en/stable/async/#picopyn.asynchronous.Pool.execute))
    - автоматическая подстройка пула соединений под актуальную топологию кластера (см. ограничения и подробности в [документации](https://picopyn.readthedocs.io/en/stable/async/#picopyn.asynchronous.Pool.topology))
