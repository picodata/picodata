...
кешируются: при повторных запросах они будут прочитаны из Picodata.
...
!!! note "Примечание"
	Здесь и далее приведен список шагов для создания плагина вручную. Эти
 	...
 	[Pike](plugin_create.md#using_pike)
...
консоли администратора](../tutorial/connecting.md#admin_console) инстанса Picodata,
...
- [Разработка плагина с помощью Pike](plugin_create.md#using_pike)
