...
- JDBC-драйвер `picodata-jdbc-5.*-shaded.jar` (доступен в [репозитории Picodata])
...
[протоколу PostgreSQL]: ../reference/config.md#instance_pgproto_listen
...
- нажмите `Добавить файл` и выберите JAR-файл `picodata-jdbc-5.*-shaded.jar`
