...
!!! note "Требования к паролю"
    ...
    См. также: [Требования к паролю](../admin/access_control.md#allowed_passwords)
...
- `forward` — количество допустимых сетевых пересылок во время исполнения
  запроса.

Более подробно эти параметры описаны в разделах [Неблокирующие
запросы](../reference/sql/non_block.md) и [DQL](../reference/sql/dql.md#params).
