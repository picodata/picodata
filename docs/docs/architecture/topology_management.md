...
[сегментов](../overview/glossary.md#segment) со всего кластера должна быть распределена
...
### Первичное распределение сегментов {: #governor_vshard_bootstrap }
...
который можно распределять [сегменты](../overview/glossary.md#segment). Для этого
