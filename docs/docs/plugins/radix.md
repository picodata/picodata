...
- выполнение SQL-команд для:
    ...
    - миграции
    - создания пользователя Radix по умолчанию
...
- Изменим версию Pike в бенчмарках на 5.0.0
...
- Улучшено использование gitlab cache для cargo
...
- Игнорирование expelled-узлов при определении режима работы
...
- 👷 улучшим вывод сообщения о релизе в телеграм
...
- Добавим документацию по конфигурации клиента sentinel
