...
Svarog предоставляет возможность версионированного хранения данных
Это может быть полезно для хранения счета клиента, когда бывает необходимо узнать состояние записи на момент времени.

Помимо этого платформа предоставляет возможность версионировать схему данных при помощи Apache Avro Schema.
...
Безопасность обеспечивается за счет следующих возможностей платформы:
...
- трассировку запросов в формате openTelemetry. Есть возможность гибко задавать какие запросы будут трассироваться,
  а какие — нет;
