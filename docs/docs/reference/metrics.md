...
Общее количество попаданий в кеш плана запроса на роутере
...
Общее количество промахов кеша плана запроса на роутере
...
Общее количество планов запросов, добавленных в кеш роутера с момента старта
...
Общее количество планов запросов, вытесненных из кеша роутера с момента старта
...
Второй запрос отправляется только при промахе кеша плана на стороне стораджа
...
Общее количество попаданий в кеш плана запроса на стороне стораджа
...
Общее количество промахов кеша плана запроса на стороне стораджа

Метки: `tier`, `replicaset`, `query_type` (`dql`), `rpc_type` (`1st`, `2nd`, `local`),
`miss_type` (`true` — отсутствие плана в кеше, `busy` — план занят другим
...
Общее количество планов запросов, добавленных в кеш стораджа с момента старта
...
Общее количество планов запросов, вытесненных из кеша стораджа с момента старта
...
Число байтов в кеше для хранения кортежей при использовании движка Vinyl
