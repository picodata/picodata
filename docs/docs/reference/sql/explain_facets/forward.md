...
При указании фасета `FORWARD` можно получить значение опции `FORWARD`, с которой
запрос гарантированно будет выполнен. Подробнее об опции `FORWARD` можно
прочитать в разделе [параметры](../dql.md#params) для DQL-запросов.
