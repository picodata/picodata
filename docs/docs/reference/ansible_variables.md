...
!!! warning title "Внимание!"
    Список переменных приведен для версии роли 25.5.1 и выше
    Переменные для других версий роли смотрите в [Документации в git-репозитории роли](https://git.picodata.io/core/picodata-ansible/-/blob/main/docs/)
...
| systemd_params | | словарь с [параметрами для Systemd](../admin/systemd.md) |
...
| systemd_params | {} | словарь с [настройками для Systemd](../admin/systemd.md) |
