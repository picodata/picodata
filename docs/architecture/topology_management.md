...
[бакетов](../overview/glossary.md#segment) со всего кластера должна быть распределена
...
который можно распределять [бакеты](../overview/glossary.md#segment). Для этого
