...
поддерживается [многострочный ввод](../tutorial/connecting.md#multiline_input).
...
[переключить](../tutorial/connecting.md#switching_console_input_lang)
...
[переключить](../tutorial/connecting.md#switching_console_input_lang). Пример
