...
Для ввода команд SQL требуется [интерактивная консоль Picodata](../tutorial/connecting.md).
...
запросов](#parametric-queries) подойдет только язык Lua.

### Ввод команд {: #query-input }
...
поддерживается [многострочный ввод](../tutorial/connecting.md#multiline-input).
...
[переключить](../tutorial/connecting.md#switching-console-input-lang)
язык консоли на Lua. Так, следующие две команды дадут одинаковый
...
сами команды SQL нечувствительны к регистру (`select` равнозначен
...
[переключить](../tutorial/connecting.md#switching-console-input-lang). Пример
