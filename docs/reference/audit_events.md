...
В данном разделе приведены события, попадающие в [журнал аудита](../overview/glossary.md#audit_log) Picodata.

## Перечень событий безопасности {: #audit_events_list }
...
#### Изменение пароля и/или метода аутентификации {: #manage_password_or_auth_method }
