...
### E011-01. Типы данных INTEGER и SMALLINT (включая все варианты написания) {: #E011-01 }

Подпункт 5.3, Установка знака для беззнакового целого

### E011-02. Типы данных REAL, DOUBLE PRECISION и FLOAT {: #E011-02 }

Подпункт 5.3, Установка знака для приблизительного числового литерала
Подпункт 6.1, Округление числового типа

### E011-03. Типы данных DECIMAL и NUMERIC {: #E011-03 }

Подпункт 5.3, Литералы точных чисел

### E011-05. Числовые сравнения {: #E011-05 }
...
### E011-06. Неявное приведение числовых типов данных {: #E011-06 }
...
### E021-01. Символьный тип данных (включая все варианты написания) {: #E021-01 }
...
### E021-03. Символьные литералы {: #E021-03 }

Подпункт 5.3

### E021-07. Конкатенация символов {: #E021-07 }

Подпункт 6.29, Выражение конкатенации

### E021-12. Сравнение символов {: #E021-12 }
...
### E031-02. Идентификаторы в нижнем регистре {: #E031-02 }
...
### E031-03. Символ нижнего подчеркивания в конце {: #E031-03 }
...
### E071-06. Табличные операторы в подзапросах {: #E071-06 }
...
### E101-01. Инструкция INSERT {: #E101-01 }
...
### F041-08. Все операторы сравнения поддерживаются (помимо обычного `=`) {: #F041-08 }
...
### E101-03. Инструкция UPDATE с поиском {: #E101-03 }

### E101-04. Инструкция DELETE с поиском {: #E101-04 }

### E011-04. Арифметические операторы {: #E011-04 }

### E071-01. Табличный оператор UNION DISTINCT {: #E071-01 }

### F041-03. LEFT OUTER JOIN {: #F041-03 }
