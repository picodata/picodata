...
-->
См. [отдельный подраздел](../tutorial) с практическим примером развертывания кластера. Дополнительно о внутренней архитектуре кластера Picodata можно узнать в разделе [Общая схема инициализации кластера](../clustering).
