...
[рабочие файлы инстанса](../architecture/instance_runtime_files.md). Также нужно указать
...
предоставляет доступ к управлению им в консоли. Подключиться к
интерактивной консоли инстанса можно командой
`picodata connect` (см. [подробнее](../tutorial/connecting.md)).
