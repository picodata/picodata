...
[Администратор СУБД]: access_control.md#admin
...
[`picodata run --share-dir`](../reference/cli.md#run_plugin_dir)
...
понадобятся Rust и Cargo 1.76 или новее. Используйте следующую команду:
