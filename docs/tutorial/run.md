...
отдельном файле. В дальнейшем, при запуске инстанса, можно будет
передать путь к этому файлу в параметре
[&#8209;&#8209;service-password-file][pwdfile]. Дополнительно, следует
явно указать способ вывода журнала аудита [&#8209;&#8209;audit][audit],
а также включить режим безопасного удаления рабочих файлов
[&#8209;&#8209;shredding][shredding].
