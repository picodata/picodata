...
### pico.raft_status
Получение данных о текущем состоянии raft-узла
...
Вызов таймаута raft-узла и немедленное объявление новых выборов в
raft-группе.

Функция используется для явного и сознательного завершения текущего
...
### pico.wait_vclock
Ожидание момента, когда значение
